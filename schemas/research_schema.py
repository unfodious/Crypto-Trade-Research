...
MARKET_CANDLE_FIELDS: tuple[FieldSpec, ...] = (
    FieldSpec("schema_version", "string", Availability.STATIC_METADATA, True, "Dataset schema version."),
    FieldSpec("venue", "string", Availability.STATIC_METADATA, True, "Exchange name such as binance."),
    FieldSpec("market_type", "string", Availability.STATIC_METADATA, True, "spot, um_futures, or cm_futures."),
    FieldSpec("symbol", "string", Availability.STATIC_METADATA, True, "Exchange symbol such as BTCUSDT."),
    FieldSpec("timeframe", "string", Availability.STATIC_METADATA, True, "Candle period."),
    FieldSpec("open_time", "timestamp[us, UTC]", Availability.POST_CLOSE, True, "Inclusive candle start."),
    FieldSpec("close_time", "timestamp[us, UTC]", Availability.POST_CLOSE, True, "Exclusive candle end."),
    FieldSpec("source_available_at", "timestamp[us, UTC]", Availability.SIGNAL_TIME, True, "Earliest safe join time."),
    ...
    FieldSpec("taker_buy_base_volume", "decimal128", Availability.POST_CLOSE, True, "Taker buy base volume."),
    FieldSpec("taker_buy_quote_volume", "decimal128", Availability.POST_CLOSE, True, "Taker buy quote volume."),
    FieldSpec("data_source", "string", Availability.STATIC_METADATA, True, "Source provenance."),
    FieldSpec("source_file", "string", Availability.STATIC_METADATA, False, "Optional source file."),
    FieldSpec("checksum", "string", Availability.STATIC_METADATA, False, "Optional source checksum."),
)
